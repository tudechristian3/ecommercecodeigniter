    ...
    <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="post" action="<?php echo base_url('ProductController/update')?>">
                            <input type="hidden" name="product_id" class="form-control" value="<?php echo $edit_products[0]['product_id']; ?>">
                                <img src="<?php echo base_url('../upload/'. $edit_products[0]['image']);?>" width="193" height="130">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Product Name" name="product_name" value="<?php echo $edit_products[0]['product_name']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Product Description" name="product_description" value="<?php echo $edit_products[0]['product_description']; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" placeholder="Product Quantity" name="product_quantity" value="<?php echo $edit_products[0]['product_quantity']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" placeholder="Product Price" name="product_price" value="<?php echo $edit_products[0]['product_price']; ?>">
                                        </div>
                                    </div>
                                </div>
                                    <div class="col-md-12">
