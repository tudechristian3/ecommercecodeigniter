...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body" id="notif">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="tablerow">
                                    <thead>
                                        <tr>
                                            <th>Photo</th>
                                            <th>Product Name</th>
                                    ...
                                    <?php foreach($categories as $c):?>
                                        <?php if($u['category_id'] == $c['category_id']):?>
                                    <tbody>
                                        <tr id="<?php echo $u['product_id']; ?>">
                                            <td><img src="<?php echo base_url('../upload/'. $u['image']);?>" width="193" height="130"></td>
                                            <td data-target="product-name"><?php echo $u['product_name']; ?></td>
                                            <td data-target="category-name"><?php echo $c['category_name']; ?></td>
                                            <td data-target="product-quantity"><?php echo $u['product_quantity']; ?></td>
                                            <td data-target="product-price"><?php echo $u['product_price']; ?></td>
                                            <td>
                                            <a href="<?php echo base_url('ProductController/edit')?>/<?php echo $u['product_id']?>" class="btn btn-primary waves-effect m-r-20">Edit</a></td>
                                            <td><a  href="<?php echo base_url('ProductController/delete')?>/<?php echo $u['product_id']; ?>" type="button" class="btn btn-danger" id="remove">Delete</a></td>
                                        </tr>    
                                    </tbody>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
    ...
    <script src="<?php echo base_url('../bootstrap/plugins/jquery-datatable/skin/bootstrap/js/dataTables.bootstrap.js')?>"></script>
    <script src="<?php echo base_url('../bootstrap/plugins/jquery-datatable/extensions/export/dataTables.buttons.min.js')?>"></script>
